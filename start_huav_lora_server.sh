...
echo "Architecture:"
echo ""
echo "  L-UAV (clients) → Self-matching → Request H-UAV"
echo "                         ↓"
echo "  H-UAV Server (this) → LoRA Memory Pool"
echo "                         ↓"
echo "  Enhanced inference → Return to L-UAV"
echo ""
echo "============================================================"
echo ""
echo "Endpoints (when started):"
echo "  Health check: http://$HOST:$PORT/health"
echo "  Inference: http://$HOST:$PORT/infer"
